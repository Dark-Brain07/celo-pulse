...
export class CeloActivityHelper {
  ...
  /**
   * Calculate estimated gas savings by using Celo vs Ethereum with strict validation.
   * @param transactionCount Number of transactions to calculate for (must be positive)
   */
