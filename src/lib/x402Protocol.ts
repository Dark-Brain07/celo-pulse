...
export const X402_ACTIONS = [
  ...
  {
    id: "standard_payment_cusd",
    type: "micropayment" as const,
    title: "Standard Payment",
    description: "Send 0.01 cUSD standard x402 payment",
    icon: "💵",
    color: "#059669",
    amount: "0.01",
    tokenAddress: X402_CONFIG.tokens.cUSD,
  ...
  {
    id: "premium_payment_cusd",
    type: "data_access" as const,
    title: "Premium Data Access",
    description: "Pay 0.1 cUSD for premium onchain analytics",
    icon: "💎",
    color: "#7c3aed",
    amount: "0.1",
    tokenAddress: X402_CONFIG.tokens.cUSD,
  ...
  {
    id: "pro_settlement_cusd",
    type: "agent_action" as const,
    title: "Pro Agent Settlement",
    description: "Execute 1.0 cUSD pro-tier agent settlement",
    icon: "🏆",
    color: "#dc2626",
    amount: "1.0",
    tokenAddress: X402_CONFIG.tokens.cUSD,
