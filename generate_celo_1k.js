...
const features = [
  ...
  'Moola-Protocol2','Ubeswap-Protocol2','Curve-Protocol2','HaloFi-Protocol2',
  'Wallet-Connectors2','Signatures2','Tx-Manager2','Gas-Estimator2',
  'UI-Charts2','UI-Tables2','UI-Modals2','UI-Notifications2',
  'State-Wallet2','State-Network2','State-Prices2','State-User2'
];
